...
public class Main_Activity extends Activity implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main);// ver isto
		init();
		if (btAdapter == null) {
    ...
    // Copy/Paste (com algumas alteracoes) from http://developer.android.com/guide/topics/connectivity/bluetooth.html
